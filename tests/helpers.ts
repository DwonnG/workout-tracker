...
export const INVITE_CODE = 'TestCode000';
export const TEST_INVITE_HASH = 'eb6fc18b37d2e1b374f0afd806be9d17151ffb35492c7bec23444e8d2e2f4e8e';
...
export async function injectTestInviteHash(page: Page) {
  await page.addInitScript(`window.__testInviteHash = '${TEST_INVITE_HASH}';`);
}
...
export async function freshLogin(page: Page) {
  await injectTestInviteHash(page);
